...
public class BladeX extends JavaPlugin implements Listener {
    ...
    public void onInventoryClick(InventoryClickEvent e) {
        ...
        // Her durumda hareketi engelle — item menu'den cikmaz
        e.setCancelled(true);

        if (e.getClickedInventory() == null) return;
        // Alt envanter (oyuncunun kendi envanteri) tiklanirsa hicbir sey yapma
        ...
        // Sadece kopyasini ver, menu'deki item kalsin
    ...
    private boolean isInProtectedRegion(Player p) {
        try {
            ...
            // PVP DENY veya null (varsayilan kapali) ise korumali bolge sayilir
