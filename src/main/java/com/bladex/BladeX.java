...
public class BladeX extends JavaPlugin implements Listener {
    ...
    public void onInventoryClick(InventoryClickEvent e) {
        ...
        // Tum hareketleri engelle — item menu'den hicbir sekilde cikmaz
        e.setCancelled(true);

        if (e.getClickedInventory() == null) return;
        // Sadece ust envanter (menu) tiklamalari isle
        ...
        // Bilgi itemi (BOOK) tiklansa da hicbir sey verme
        if (clicked.getType() == Material.BOOK) return;

        // Sadece sol veya sag tikla ver
    ...
    // Surukle ile de item cikarilmasin
    @EventHandler(priority = EventPriority.HIGHEST)
